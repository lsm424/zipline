...
class DataPortal:
    ...
    def __init__(
        ...
        self.last_dt, self.last_session_lable = None, None
    ...
    def _tz_localize(self, date: pd.Timestamp, tz: str):
    ...
    def _get_single_asset_value(self, session_label, asset, field, dt, data_frequency):
        ...
        if (
            dt < self._tz_localize(asset.start_date, dt.tzinfo)
    ...
    def get_spot_value(self, assets, field, dt, data_frequency):
        ...
        if dt == self.last_dt:
            session_label = self.last_session_lable
        else:
            self.last_session_lable = session_label = self.trading_calendar.minute_to_session(dt)
            self.last_dt = dt
